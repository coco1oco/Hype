export const events = [
  {
    ...
    tagline:
      "A 360° stage experience that wrapped Philippine Arena in pink light.",
    category: "Trending",
    ...
    accessibility: true,
    description:
      "TWICE’s “This Is For” world tour stop delivered a two-hour set packed with “Fancy,” “What Is Love?,” “Feel Special,” and new album cuts, all performed on a rotating 360-degree stage for ONCE PH.",
    heroColor: "#171339",
    heroAccent: "#ffb5e1",
    hypeScore: 97,
    cover: "/twice.jpg",
  ...
  },
  {
    ...
    accessibility: true,
    description:
      "A limited-run <DEADLINE> stop with monochrome visuals, orchestral remixes, and a surprise final act for Filipino BLINKs.",
    heroColor: "#05020d",
    heroAccent: "#f4b2d6",
    hypeScore: 98,
    cover: "/blackpink.jpg",
    ...
    tiers: [
      {
        ...
        availability: "Limited",
        perks: [
          "Soundcheck film session",
          "Exclusive monochrome merch kit",
          "Early entry",
        ],
        capacity: 400,
      },
  ...
  },
  {
    ...
    accessibility: true,
    description:
      "Tyla’s first Manila show brings the “We Wanna Party” Asia tour to MOA Arena with a bass-heavy set built around “Water,” “ART,” and amapiano reworks of fan favorites.",
    heroColor: "#1d0f2a",
    heroAccent: "#ff9ed1",
    hypeScore: 89,
    cover: "/tyla.jpg",
    ...
    tiers: [
      {
        ...
        availability: "Limited",
        perks: [
          "Preshow soundcheck party",
          "Front dancefloor access",
  ...
  },
  {
    ...
    accessibility: true,
    description:
      "DAY6 marks ten years with “The DECADE,” a Manila stop featuring orchestral intros, extended jams of “You Were Beautiful,” “Time of Our Life,” and fan-selected deep cuts.",
    heroColor: "#081424",
    heroAccent: "#6ad1ff",
    hypeScore: 85,
    cover: "/day6.jpg",
    ...
    tiers: [
      {
        ...
        perks: [
          "Soundcheck entry",
          "Hi-touch photo moment",
          "Anniversary badge set",
        ],
        capacity: 400,
      },
      {
  ...
  },
  {
    ...
    accessibility: true,
    description:
      "A comprehensive workshop covering React, Node.js, and modern development practices. Includes hands-on coding sessions and networking opportunities.",
    heroColor: "#0a1929",
    heroAccent: "#61dafb",
    hypeScore: 68,
    cover:
  ...
  },
  {
    ...
    accessibility: true,
    description:
      "Experience an elegant evening of smooth jazz performances featuring local and international artists. Includes welcome drinks and light refreshments.",
    heroColor: "#1a1a2e",
    heroAccent: "#f4a261",
    hypeScore: 72,
    cover:
  ...
  },
  {
    ...
    accessibility: true,
    description:
      "A student-centered hackathon where teams ship wild prototypes over one weekend, from AI side projects to playful campus tools.",
    heroColor: "#050816",
    heroAccent: "#64ffda",
    hypeScore: 82,
    cover: "/cs.png",
  ...
  },
  {
    ...
    accessibility: true,
    description:
      "Guild leaders, devs, and players gather for a day of talks, live tournaments, and hands-on demos of the next wave of play-and-own titles.",
    heroColor: "#05020d",
    heroAccent: "#ffdd57",
    hypeScore: 88,
    cover:
  ...
  },
  {
    ...
    accessibility: true,
    description:
      "Two days of keynotes, demos, and hallway conversations around AI agents, infrastructure, and real-world deployments.",
    heroColor: "#040b1a",
    heroAccent: "#00d4ff",
    hypeScore: 94,
    cover:
  ...
  },
  {
    ...
    title: "Flair DLSU-D",
    tagline:
      "A campus festival for creators, performers, and student founders.",
    category: "Chill",
    ...
    accessibility: true,
    description:
      "An all-evening student fair with live bands, founder booths, art pop-ups, and food trucks under campus lights.",
    heroColor: "#1b0b2e",
    heroAccent: "#ff6f91",
    hypeScore: 79,
    cover:
  ...
  },
  {
    ...
    accessibility: true,
    description:
      "The iconic year-end Paskuhan with lantern parades, org booths, and bands playing into the night.",
    heroColor: "#0c1a24",
    heroAccent: "#ffd166",
    hypeScore: 92,
    cover:
  ...
  },
  {
    ...
    accessibility: true,
    description:
      "A student-organized fest mixing spoken word, campus bands, and org booths centered on free expression and community.",
    heroColor: "#1c1124",
    heroAccent: "#f78da7",
    hypeScore: 76,
    cover: "/cvsu.jpg",
  ...
  },
  {
    ...
    title: "Hamilton",
    tagline:
      "The international tour of the Broadway phenomenon arrives in Manila.",
    category: "Fan Favorite",
    ...
    accessibility: true,
    description:
      "Lin-Manuel Miranda’s Tony Award-winning musical about Alexander Hamilton, staged with the original creative team’s touring production.",
    heroColor: "#1b1206",
    heroAccent: "#f2c94c",
    hypeScore: 95,
    cover: "/ham.jpg",
  ...
  },
  {
    ...
    accessibility: true,
    description:
      "Teams prototype cloud-native solutions with mentorship from AWS SA's and compete for credits, swag, and spotlight time.",
    heroColor: "#0b1829",
    heroAccent: "#ff9900",
    hypeScore: 87,
    cover:
...
export const filterEvents = (filters) => {
  ...
  // THIS PART is required for date filtering
  if (filters.date) {
    filtered = filtered.filter((e) => {
      const eventDate = new Date(e.startTime).toISOString().split("T")[0];
      return eventDate === filters.date; // both "yyyy-mm-dd"
    });
  }
